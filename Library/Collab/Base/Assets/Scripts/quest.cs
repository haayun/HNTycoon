...
public class quest : MonoBehaviour
{
    ...
    public Text quest1_ing, quest2_ing, quest3_ing, quest4_ing_suit, quest4_ing_goggle, quest4_ing_flipper, quest5_ing, quest6_ing_suit, quest6_ing_goggle, quest6_ing_flipper;
    ...
    public void check_quest()
    {
        ...
        {
            case 0:
                if (Haenyeo.sea_item_number[0] > 4) //조개 5개 모아오기 성공했을 때
                {
                    quest1_ing.text = "5";
            ...
            case 1: // 조개 한 번 수확하기
                //if (GameObject.Find("farm0").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm1").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm2").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm3").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm4").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm5").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm6").transform.Find("money").gameObject.activeSelf == true ||
                //   GameObject.Find("farm7").transform.Find("money").gameObject.activeSelf == true)
            ...
            case 2: // 송금하기
                //if (farm_manager.is_repay_locked == true) // 송금 후 송금버튼이 비활성화되면
            ...
            case 3: // 장비 업그레이드
                    //수민 - 이거 그냥 테스트용으로 무조건 되게 해둘게요
                    /* 
                    if (equipment_upgrade.my_suit == 1 && equipment_upgrade.my_goggle == 1 && equipment_upgrade.my_flipper == 1)
                    {
                        quest4_ing_suit.text = "1";
                        quest4_ing_goggle.text = "1";
                        quest4_ing_flipper.text = "1";
                        quest_state = (int)Quest_state.DONE;
                        reward_on.gameObject.SetActive(true);   //보상받기 버튼 활성화
                        reward_off.gameObject.SetActive(false);
                    }
                    ...
                    {
                        quest4_ing_suit.text = "0";
                        quest4_ing_goggle.text = "0";
                        quest4_ing_flipper.text = "0";
            ...
            case 4: // 양식장 확장
                ...
                /*
                if (GameObject.Find("farm0").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm1").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm2").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm3").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm4").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm5").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm6").transform.Find("locked_bg").gameObject.activeSelf == true &&
                   GameObject.Find("farm7").transform.Find("locked_bg").gameObject.activeSelf == true)
                {
                    quest5_ing.text = "8";
                    quest_state = (int)Quest_state.DONE;
                    reward_on.gameObject.SetActive(true);   //보상받기 버튼 활성화
                ...
                else
                {
                    ...
                    if (GameObject.Find("farm1").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm2").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm3").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm4").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm5").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm6").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    if (GameObject.Find("farm7").transform.Find("locked_bg").gameObject.activeSelf == true)
                    {
                        i++;
                    }
                    quest5_ing.text = i.ToString();
                    quest_state = (int)Quest_state.ING;
                    reward_on.gameObject.SetActive(false);
                    reward_off.gameObject.SetActive(true);  //보상받기 버튼 비활성화
                ...
                */
                ...
                else
                {
                    quest5_ing.text = "0";
                    quest_state = (int)Quest_state.DONE;
                    reward_on.gameObject.SetActive(false);   //보상받기 버튼 활성화
    ...
    {
        quest_ui[quest_number].gameObject.SetActive(true);
    }
